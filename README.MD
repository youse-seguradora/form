...
```groovy
implementation 'br.com.youse.forms:form-jdk:0.3.0'
implementation 'br.com.youse.forms:rx-form-jdk:0.3.0'
implementation 'br.com.youse.forms:validators-jdk:0.3.0' // optional
implementation 'br.com.youse.forms:formatters-jdk:0.3.0' // optional
```
